...
<template>
  <std-sheet>
    <div class="orangehrm-header-container">
      <std-text type="card-title">Grid Demo</std-text>
    ...
    <std-divider />
    <std-form>
      <std-grid :cols="cols.id">
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Oraganization Name" />
          </std-form-row>
        </std-grid-item>
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Number of Employees" />
          </std-form-row>
        </std-grid-item>
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Registation Number" />
          </std-form-row>
        </std-grid-item>
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Tax Id" />
          </std-form-row>
        </std-grid-item>
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Phone" />
          </std-form-row>
        </std-grid-item>
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Fax" />
          </std-form-row>
        </std-grid-item>
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Email" />
          </std-form-row>
        </std-grid-item>
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Address Street 1" />
          </std-form-row>
        </std-grid-item>
        <std-grid-item>
          <std-form-row>
            <std-input-field label="Address Street 2" />
          </std-form-row>
        </std-grid-item>
      </std-grid>
      ...
      <std-divider />
      <std-form-actions>
        <std-button label="Cancel" displayType="ghost" />
        <std-button
          label="Save"
          type="submit"
