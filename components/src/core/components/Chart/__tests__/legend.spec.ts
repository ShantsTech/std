...
describe('Chart > Legend.vue', () => {
  ...
  it('should renders STD chart legend', () => {
  ...
  it('should have four key elements', () => {
    ...
    expect(wrapper.findAll('.std-chart-legend-key').length).toStrictEqual(4);
  });
  ...
  it('should emit index on click', async () => {
    ...
    await wrapper.findAll('.std-chart-legend-key + span')[3].trigger('click');
