...
import CardTable from '@sthrm/std/core/components/CardTable/CardTable.vue';
...
describe('CardTable > CardTable.vue', () => {
  it('renders STD CardTable > CardTable', () => {
  ...
  it('should renders STD CardTable > CardTable without selectable', () => {
    const wrapper = mount(CardTable, {
      props: {
        headers: DUMMY_DATA.headers,
        items: DUMMY_DATA.items,
  ...
  it('should renders STD CardTable > CardTable with card decorator', () => {
    const wrapper = mount(CardTable, {
      props: {
        headers: DUMMY_DATA.headers,
        items: DUMMY_DATA.items,
  ...
  it('should renders STD CardTable > CardTable with selector config', () => {
    const wrapper = mount(CardTable, {
      props: {
