...
describe('DropdownInput.vue', () => {
  ...
  it('should not open the dropdown when the el is clicked but the component is disabled', async () => {
    ...
    expect(wrapper.find('.std-dropdown-options').exists()).toBeFalsy();
  });
  ...
  it('should open the dropdown when the el is clicked', async () => {
    ...
    expect(wrapper.find('.std-dropdown-options').exists()).toBeTruthy();
  });
  ...
  it('should not open the dropdown when the arrow is clicked if disabled', async () => {
    ...
    await wrapper.vm.$nextTick();
    wrapper.find('.std-icon.--arrow').trigger('click');
    expect(wrapper.find('.std-icon.--arrow').classes()).toContain(
      'bi-caret-down-fill',
    );
    await wrapper.vm.$nextTick();
    expect(wrapper.find('.std-icon.--arrow').classes()).toContain(
  ...
  it('will select options from dropdown', async () => {
    ...
    wrapper.findComponent(Input).trigger('click');
    await wrapper.vm.$nextTick();
    expect(wrapper.findAll('.std-dropdown-options-item').length).toEqual(3);
    wrapper.findAll('.std-dropdown-options-item')[0].trigger('mousedown');
    await wrapper.vm.$nextTick();
  ...
  it('will select multiple options from dropdown', async () => {
    ...
    wrapper.findComponent(Input).trigger('click');
    await wrapper.vm.$nextTick();
    wrapper.findAll('.std-dropdown-options-item')[1].trigger('mousedown');
    await wrapper.vm.$nextTick();
    expect(wrapper.emitted('update:modelValue')).toBeTruthy();
  });
  ...
  it('will clear select options from dropdown', async () => {
    ...
    await wrapper.vm.$nextTick();
    wrapper.find('.std-icon.--clear').trigger('click');
    await wrapper.vm.$nextTick();
    expect(wrapper.emitted('update:modelValue')).toBeTruthy();
  ...
  it('will display clear icon', async () => {
    ...
    await wrapper.vm.$nextTick();
    expect(wrapper.find('.std-icon.--clear').exists()).toBeTruthy();
  });
  ...
  it('will not display clear icon if not selected', async () => {
    ...
    await wrapper.vm.$nextTick();
    expect(wrapper.find('.std-icon.--clear').exists()).toBeFalsy();
  });
