...
<template>
  ...
  >
    <div class="std-dropdown-input">
      ...
      <div
        v-if="!isLoading"
        :class="{'std-dropdown-input-icon': true, '--disabled': disabled}"
      >
        <std-icon
      ...
      <std-loading-spinner
        class="std-dropdown-input-loader"
        v-else
        :with-container="false"
      />
    </div>
    <transition name="transition-fade-down">
      <ul role="listbox" v-if="open" class="std-dropdown-options">
        <li
          ...
          :class="{
            'std-dropdown-options-item': true,
        ...
        <li
          ...
          class="std-dropdown-options-item --disabled"
        >
          {{ t('general.no_options', 'No options') }}
        </li>
      </ul>
    </transition>
    <div class="std-dropdown-selected" v-if="multiple">
      <std-chip
        v-for="(option, index) in selectedOptions"
        :key="`${index}-selected-${option.id}`"
        :label="option.label"
        class="std-dropdown-selected-chip"
      >
        <std-icon
