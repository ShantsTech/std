...
<template>
  <div @fullscreenchange="onFullScreenChange" ref="tableRef" :class="classes">
    <div class="std-report-table-header">
      <div class="std-report-table-header--toggable">
        <std-icon-button
          class="--toggable-icon"
          :name="fullScreenIcon"
          :withContainer="false"
      ...
      <div class="std-report-table-header--pagination">
        <slot name="pagination"></slot>
      </div>
    </div>
    <div v-if="loading" class="std-report-table-loader">
      <std-loading-spinner />
    </div>
    <v-grid
      v-else
      ...
      v-bind="$attrs"
    ></v-grid>
    <div class="std-report-table-footer">
