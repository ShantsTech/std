...
describe('InputField.vue', () => {
  ...
  it('renders STD InputField type `input`', () => {
    const wrapper = mount(InputField, {
      props: {type: 'input'},
      global: {
        provide: {
  ...
  it('renders STD InputField type `file`', () => {
    const wrapper = mount(InputField, {
      props: {type: 'file'},
      global: {
        provide: {
  ...
  it('renders STD InputField type `file` with button', () => {
    const wrapper = mount(InputField, {
  ...
  it('renders STD InputField type `textarea`', () => {
    const wrapper = mount(InputField, {
      props: {type: 'textarea'},
      global: {
        provide: {
