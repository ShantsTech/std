...
export default defineComponent({
  ...
  computed: {
    classes(): object {
      return {
        'std-switch-input': true,
        'std-switch-input--active': !this.focused,
        'std-switch-input--focus': this.focused,
        'std-switch-input--error': this.hasError,
