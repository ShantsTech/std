  ...
  <div class="std-radio-wrapper">
    <label :class="{'--disabled': disabled}">
      ...
      <input
        ...
        :disabled="disabled"
      />
      <span :class="classes" :style="style" class="std-radio-input"></span>
...
export default defineComponent({
  ...
  computed: {
    classes(): object {
      return {
        'std-radio-input': true,
        'std-radio-input--active': !this.focused,
        'std-radio-input--focus': this.focused,
        'std-radio-input--error': this.hasError,
