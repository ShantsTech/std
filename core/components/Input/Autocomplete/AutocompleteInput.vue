...
<template>
  <div class="std-autocomplete-wrapper">
    <std-autocomplete-text-input
      v-bind="$attrs"
      :clear="showClear"
    ...
    <std-autocomplete-dropdown
      v-if="dropdownOpen"
      :class="dropdownClasses"
      :loading="loading"
      :empty="computedOptions.length === 0"
    >
      <std-autocomplete-option
...
export default defineComponent({
  name: 'std-autocomplete-input',
  inheritAttrs: false,

  components: {
    'std-autocomplete-text-input': AutocompleteTextInput,
    'std-autocomplete-dropdown': AutocompleteDropdown,
    'std-autocomplete-option': AutocompleteOption,
    'std-autocomplete-chips': AutocompleteChips,
  },
