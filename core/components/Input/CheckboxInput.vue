...
<template>
  <div class="std-checkbox-wrapper">
    <label :class="{'--disabled': disabled}">
      ...
      <input
        ...
        v-model="checked"
      />
      <span :class="classes" :style="style" class="std-checkbox-input">
        <std-icon class="std-checkbox-input-icon" :name="checkIcon" />
      </span>
...
export default defineComponent({
  ...
  computed: {
    classes(): object {
      return {
        'std-checkbox-input': true,
        'std-checkbox-input--active': !this.focused,
        'std-checkbox-input--focus': this.focused,
        'std-checkbox-input--error': this.hasError,
