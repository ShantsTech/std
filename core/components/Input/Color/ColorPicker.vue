...
<template>
  <div role="alert" class="std-color-picker">
    <div
      class="std-color-picker-indicator"
    ...
    <canvas
      ...
      width="228"
      height="228"
      class="std-color-picker-palette"
    ...
    <input
      :value="hue"
      @change="onHueChange"
      class="std-color-picker-range"
      type="range"
      max="359"
    />
    <std-label
      :label="t('general.hex', 'HEX')"
      class="std-color-picker-label"
    />
    <std-input :value="modelValue" @update:modelValue="onHexInput" />
  </div>
</template>
