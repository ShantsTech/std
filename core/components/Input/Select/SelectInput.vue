...
<template>
  <div class="std-select-wrapper">
    ...
    >
      <std-select-option v-if="showEmptySelector" @select="onClear">
        {{ placeholderText }}
      </std-select-option>
      <std-select-option
...
export default defineComponent({
  name: 'std-select-input',
  inheritAttrs: false,

  components: {
    'std-select-text': SelectText,
    'std-select-dropdown': SelectDropdown,
    'std-select-option': SelectOption,
  },
