...
export default defineComponent({
  name: 'std-table-cell-container',
  inject: ['screenState'],

  components: {
    'std-table-cell-default': DefaultCell,
    'std-table-cell-actions': ActionsCell,
    'std-table-cell-checkbox': CheckboxCell,
  },
  ...
  render() {
    ...
    const defaultCell = resolveComponent('std-table-cell-default');
